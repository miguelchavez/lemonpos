...
#ifndef MIBITMESSAGE_H
#define MIBITMESSAGE_H
...
class MibitMessage : public QSvgWidget
{
Q_OBJECT
public:
    MibitMessage(QWidget *parent = 0, const QString &msg = 0, const QString &file = 0, const QPixmap &icon = 0, AnimationType animation = atSlideDown );
    ~MibitMessage();
    void showMessage( const QString &msg = 0, AnimationType animation = atSlideDown );
