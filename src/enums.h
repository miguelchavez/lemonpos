...
enum cashFlowType     {ctCashOut=1, ctCashOutMoneyReturnOnCancel=2, ctCashOutMoneyReturnOnProductReturn=3, ctCashIn=4, ctCashInReservation=5, ctCashOutReservation=6, ctCashInCreditPayment=7};
